...
class BaselineModels:
    ...
    def evaluate_model(self, model, X_test, y_test, model_name):
        ...
        report = classification_report(
            y_test, y_pred, target_names=list(EMOTION_LABELS.values()), output_dict=True
        )
...
def main():
    ...
    uit_vsfc_path = "data/processed_uit_vsfc_data.csv"
    ...
    for result in results:
        print(
            f"{result['model_name']}: F1={result['f1_score']:.4f}, Accuracy={result['accuracy']:.4f}"
        )
