...
from siic.utils.config import (EMOTION_LABELS, LABEL_TO_ID, MODEL_CONFIGS,
    ...
    def evaluate(self, test_loader):
        ...
        print(
            classification_report(
                all_targets, all_predictions, target_names=list(self.emotion_labels.values())
            )
        )
...
def main():
    ...
    # Train model
    training_history = lstm_detector.train(train_loader, val_loader, epochs=15, learning_rate=0.001)
