...
from siic.utils.config import (PROCESSED_DATA_DIR, RAW_DATA_DIR,
...
class VietnameseTextPreprocessor:
    ...
    def preprocess_dataframe(
        self, df: pd.DataFrame, text_column: str, label_column: str = None
    ) -> pd.DataFrame:
...
def create_sample_data():
    ...
    sample_data = {
        ...
        "emotion": (["happy"] * 6 + ["sad"] * 6 + ["angry"] * 6 + ["neutral"] * 6),
    }
