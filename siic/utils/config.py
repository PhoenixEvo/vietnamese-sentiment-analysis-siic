...
EMOTION_LABELS_4CLASS = {0: "angry", 1: "sad", 2: "neutral", 3: "happy"}
...
MODEL_CONFIGS = {
    "logistic_regression": {"C": 1.0, "max_iter": 1000, "random_state": RANDOM_STATE},
    "lstm": {"embedding_dim": 100, "hidden_dim": 128, "num_layers": 2, "dropout": 0.3},
    "phobert": {
