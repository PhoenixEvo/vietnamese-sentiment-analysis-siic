...
from siic.utils.config import (MODEL_CONFIGS, MODELS_DIR, RANDOM_STATE,
                               RESULTS_DIR)
...
class UnifiedTrainer:
    ...
    def train_lstm(self, **kwargs):
        ...
        detector = LSTMEmotionDetector(max_length=kwargs.get("max_length", 128))
...
def main():
    ...
    parser.add_argument(
        "--model",
        choices=["phobert", "lstm", "baselines"],
        required=True,
