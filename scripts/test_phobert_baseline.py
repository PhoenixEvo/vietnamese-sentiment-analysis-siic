...
def main():
    ...
    print(f"  Accuracy: +{(baseline_results['accuracy'] - random_results['random_accuracy'])*100:.1f}%")
    print(f"  F1-Score: +{(baseline_results['f1_score'] - random_results['random_f1_score'])*100:.1f}%")
