...
def main():
    ...
    parser.add_argument(
        "--comprehensive", action="store_true", help="Run comprehensive evaluation of all models"
    )
    parser.add_argument(
        "--model", choices=["phobert", "lstm", "baselines"], help="Evaluate specific model"
    )
    parser.add_argument(
        "--generate-report", action="store_true", help="Generate final evaluation report"
    )
