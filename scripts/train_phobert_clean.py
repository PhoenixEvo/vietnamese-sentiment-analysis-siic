...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('phobert_training.log'),
...
def main():
    ...
    parser.add_argument('--model_name', type=str, default='vinai/phobert-base', help='PhoBERT model name')
    ...
    try:
        ...
        results_path = os.path.join(RESULTS_DIR, f"phobert_results_{datetime.now().strftime('%Y%m%d_%H%M%S')}.pkl")
